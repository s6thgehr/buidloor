...
const TOKEN_NAME = "BUIDL";
const TOKEN_SYMBOL = "BDL";
const TOKEN_DESCRIPTION = "A token for buidloors";
const TOKEN_IMAGE_NAME = "buidloor.png"; // Replace unicorn.png with your image name
